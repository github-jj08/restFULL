...
<form action="modify" method="post">
	...
	<input type="hidden" name="destination_name" value="${modify_view.destination_name}"/>
		...
		여행지이름 변경은 불가능합니다.
		<br/>
		여행지 이름 : ${modify_view.destination_name}
		<hr/>
		위치 검색 : <div class="search" style="">
				...
				<div id="map" style="width: 100%; height: 350px; position: relative; overflow: hidden;">
					...
					<!-- 입력할 주소 출력 -->
					<div>
							지번 주소 : <input id="jibunAddr" name="jibunaddress" type="text" style="width:50%" value="${modify_view.jibunaddress}"><br/>
							도로명 주소 : <input id="doroAddr" name="doroaddress" type="text" style="width:50%" value="${modify_view.doroaddress}"><br/>
			          		추가 주소 : <input id="detailAddr" name="details" type="text" style="width:50%" value="${modify_view.details}"><br/>
			          		x 좌표 : <input id="gps-x" name="lat" type="text" style="width:50%" value="${modify_view.lat}"><br/>
			          		y 좌표 : <input id="gps-y" name="lng" type="text" style="width:50%" value="${modify_view.lng}"><br/>
...
<input type="submit" id="submit" value="수정완료" style="position:absolute;"/>
</form>
</body>
</html>